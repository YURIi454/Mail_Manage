...
urlpatterns = [
    ...
    # path("recipient_create", cache_page(CACHE_TTL)(RecipientCreateView.as_view()), name="recipient_create"),# TODO
    ...
    #     path("newsletter_create", cache_page(CACHE_TTL)(NewsletterCreateView.as_view()), name="newsletter_create"),# TODO
    ...
    #     path("message_create", cache_page(CACHE_TTL)(YourMessageCreateView.as_view()), name="message_create"),# TODO
    ...
    path("manager_users_and_newsletters/", ManagerNewslettersListView.as_view(), name="manager_users_and_newsletters"),
